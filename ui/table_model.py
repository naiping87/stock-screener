...
COLUMN_HELP = {
    ...
    "trend_status": "Long-term trend vs EMA200: above_ema200 / below_ema200_rising / below_ema200_weak. Reported separately from Setup Type — a SETUP can still be below a weak EMA200.",
    "ema200_dist_pct": "% distance of price from EMA200 (negative = below). Independent from setup score.",
    "ema200_slope": "EMA200 slope over the last 10 bars (positive = rising long-term trend).",
