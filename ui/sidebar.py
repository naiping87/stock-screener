...
class Sidebar(QWidget):
    ...
    def _build(self):
        ...
        self.vol_daily = _sp("Daily Min", 0, 100_000_000, VOL_MIN, 100_000)
        vol_l.addWidget(self.vol_daily)
        self.vol_hourly = _sp("Hourly Min", 0, 100_000_000, VOL_MIN_HOURLY, 10_000)
        vol_l.addWidget(self.vol_hourly)
        self.vol_weekly = _sp("Weekly Min", 0, 100_000_000, WEEKLY_VOL_MIN, 100_000)
        vol_l.addWidget(self.vol_weekly)
        self.vol_d_kdj = _sp("Daily KDJ Min", 0, 100_000_000, DAILY_VOL_MIN, 100_000)
